...
class dbLocalWorker():
    ...
    def addNewUser(self, userId):
        self.db[str(userId)] = dict(lastBotMessageId=None,
                                    lastRecognizedText=None)

    def setLastBotMessageId(self, userId, messageId):
        self.db[str(userId)]['lastBotMessageId'] = messageId

    def getLastBotMessageId(self, userId):
        return self.db[str(userId)]['lastBotMessageId']
